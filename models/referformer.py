...
class ReferFormer(nn.Module):
    ...
    def forward(self, samples: NestedTensor, img_evfs_sap, captions, targets):
        ...
        pred_mask, sen_feat = self.evf_model(imgs, img_evfs, batch_size,input_ids, attention_masks, offset, resize,
                                   self.inference)
