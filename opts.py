...
def get_args_parser():
    ...
    parser.add_argument('--lr_bifit_names', default=['vlfusion_module','vtfusion_module','feat_ifi','text_linear','query_ifi','vltoken','mask_linear','mask_product','vmtoken','ifi_layers','sen_ifi','mtfusion_module','mask_text_fuser','mask_dsp','mask_iou_conv','mask_iou_linear','mmfusion_module','objfusion_module','mem_inter','fmfusion_module','mmfusion_layers','matextfusion_module','objfusion_layers','vtlfusion_module','vtlatten'], type=str, nargs='+')
    parser.add_argument('--lr_text_encoder', default=5e-5, type=float)
    parser.add_argument('--lr_text_fusion', default=5e-5, type=float)
    parser.add_argument('--lr_text_encoder_names', default=['obj_fusion','text_pre_linear','text_post_linear','text_fusion','pred_ious_mlp'], type=str, nargs='+')
    parser.add_argument('--lr_text_fusion_names', default=['text_fusion_module'], type=str, nargs='+')
