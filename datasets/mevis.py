...
def build(image_set, args):
    ...
    dataset = MeViSDataset(img_folder, ann_file, sam_transforms=sam_transforms(image_set, max_size=1024), beit_transforms=beit_transforms(), return_masks=args.masks,
